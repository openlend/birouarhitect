...
const footerSections = [
  {
    title: 'Explorează',
    links: [
      { label: 'Director Birouri', href: '/directory' },
      { label: 'Articole', href: '/news' },
  ...
  },
  {
    title: 'Companie',
    links: [
      { label: 'Adaugă Biroul Tău', href: '/submit' },
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="inline-flex items-center space-x-2 mb-6 group">
              <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center transition-transform group-hover:scale-110">
                <span className="text-slate-900 font-serif font-bold text-2xl">BA</span>
              </div>
            ...
            <p className="text-slate-400 mb-6 max-w-sm">
              Găsește cei mai buni arhitecți pentru proiectul tău. 
              Conectăm clienții cu profesioniști verificați din întreaga țară.
            </p>
            ...
            <div className="flex items-center space-x-4">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-white hover:text-slate-900 transition-all"
